      ...
      <section className="text-gray-500 body-font">
        <div className="container px-4 py-24 mx-auto">
          <div className="flex flex-wrap -m-4">
            {data.map(item => (
              <div key={item.id} className="p-4 md:w-1/3 flex justify-between">
                <div className="h-full border-2 border-gray-500 rounded-lg overflow-hidden">
                  <img className="lg:h-72 md:h-36 w-full object-scale-down object-center py-2" src={item.image} alt="blog" />
                  <div className="p-6 h-3/6 height overflow-ellipsis bg-gray-100 flex-grow-0">
                    ...
                    <div className="flex items-center flex-wrap">
                      <a className="text-yellow-600 inline-flex items-center md:mb-2 lg:mb-0">Learn More
